...
{
    this->cam_IP =  QString(msg.baseParams.cameraBase.ip.c_str()) ;
    this->cam_ID = QString(msg.baseParams.cameraBase.name.c_str()) ;
    this->cam_Pass = QString(msg.baseParams.cameraBase.code.c_str()) ;

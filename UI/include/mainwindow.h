...
public:
    ...
    void initLidarDriveInterface(std::shared_ptr<LidarDriveInterface> msg)
    {
        lidarDriveInterface = msg;
    }
    void initCameraDriveInterface(std::shared_ptr<CameraDriveInterface> msg)
    {
        cameraDriveInterface = msg;
    }
